...
//    private String imagePath = "/imageFile/" + new SimpleDateFormat("yyyyMMddHH").format(new Date()) + "";// 配置图片路径  
    private String imagePath = "/imageFile/";// 配置图片路径  
     ...
     * @throws IOException 
     */  
    public String uploadImage1(HttpServletRequest request,MultipartFile file, String getUploadContentType, String getUploadFileName) throws IOException  
    {  
...
//        System.out.println("        //最后返回图片路径   " + imagePath);  
        ...
        {  
            scaledImage = scaleImage.imageZoomOut(srcBufferImage, w, h);  //将图片进行缩放。
            FileOutputStream out = new FileOutputStream(getImagePath + "/" + fileNewName);  
            ImageIO.write(scaledImage, "jpeg", out);  
  
        }  
        
        return getImagePath + "/" + fileNewName; //返回图片路径
    }  
