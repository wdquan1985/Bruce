...
public class PageInation extends JdbcDaoSupport{
	  ...
	  public static final int NUMBERS_PER_PAGE = 10;
	   ...
	   //当前页码
	    ...
	    public PageInation(String sql){
	      ...
	      new PageInation(sql,currentPage,NUMBERS_PER_PAGE,jTemplate);
	    }
	     ...
	     */
	    public PageInation(String sql,int currentPage,int numPerPage,JdbcTemplate jTemplate){
	      if(jTemplate == null){
	        throw new IllegalArgumentException("com.deity.ranking.util.Pagination.jTemplate is null,please initial it first. ");
