...
public class MyEncoder { 
    ...
    public static String sha_256(String userName,String password) throws NoSuchAlgorithmException {       
        ShaPasswordEncoder sha = new ShaPasswordEncoder(256);   
        sha.setEncodeHashAsBase64(true);
        String pwd = sha.encodePassword(password,userName);
        System.out.println("哈希算法 256: " + pwd + " len=" + pwd.length());
        return pwd;
    }   
        
    public static String sha_SHA_256(String userName,String password) {     
    ...
    public static String md5_SystemWideSaltSource (String userName,String password) {     
        Md5PasswordEncoder md5 = new Md5PasswordEncoder();  
        md5.setEncodeHashAsBase64(false);
